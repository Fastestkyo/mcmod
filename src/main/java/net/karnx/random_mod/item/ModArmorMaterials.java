    ...
    public static final RegistryEntry<ArmorMaterial> PINK_GARNET_ARMOR_MATERIAL = registerArmorMaterial("pink_garnet",
            () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                ...
                map.put(ArmorItem.Type.BODY, 4);
                    ...
                    List.of(new ArmorMaterial.Layer(Identifier.of(RandomMod.MOD_ID, "pink_garnet"))), 0,0));

    public static final RegistryEntry<ArmorMaterial> SLIME_ARMOR_MATERIAL = registerArmorMaterial("slime_armor",
            () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
            ...
            }), 20, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, () -> Ingredient.ofItems(Items.SLIME_BALL),
                    List.of(new ArmorMaterial.Layer(Identifier.of(RandomMod.MOD_ID, "slime_armor"))), 0,0));
