package net.karnx.random_mod.sound;
...
public class ModSounds {
    ...
    public static final RegistryKey<JukeboxSong> BAR_BRAWL_KEY = RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(RandomMod.MOD_ID, "bar_brawl"));
    ...
    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = Identifier.of(RandomMod.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }


    public static void registerSounds() {
        RandomMod.LOGGER.info("Registering Sounds For " + RandomMod.MOD_ID);
    }
}
